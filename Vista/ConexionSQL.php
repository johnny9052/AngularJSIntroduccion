...
<html>
    <head>
        <meta charset="UTF-8">
        <title></title>      
        <link href="../Recursos/bower_components/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
        <link href="../Recursos/css/filtro.css" rel="stylesheet" type="text/css"/>        
        <script src="../Recursos/bower_components/angular/angular.min.js" type="text/javascript"></script>
        <!-- PARA COSUMO REST -->
        <script src="../Recursos/bower_components/angular-route/angular-route.min.js" type="text/javascript"></script>
        <script src="../Recursos/bower_components/angular-resource/angular-resource.min.js" type="text/javascript"></script>        
        <script src="../Recursos/js/General/appTareasDBSQL.js" type="text/javascript"></script>
        <script src="../Recursos/js/General/tareasDBRestFul.js" type="text/javascript"></script>
        <script src="../Recursos/js/General/crud.js" type="text/javascript"></script>
