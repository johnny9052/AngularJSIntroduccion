...
<!--        <script src="../Recursos/js/angular/angular.min.js" type="text/javascript"></script>-->
        ...
        <script src="../Recursos/js/General/tareasDB.js" type="text/javascript"></script>
        <script src="../Recursos/bower_components/firebase/firebase.js" type="text/javascript"></script>
        <script src="../Recursos/bower_components/angularfire/dist/angularfire.min.js" type="text/javascript"></script>
    </head>
