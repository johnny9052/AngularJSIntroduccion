...
app.controller('CtlRol', function ($scope, $window, rolService) {
    ...
    $scope.guardar = function (form) {
        ...
        if (form) {
            ...
            rolService.guardar($scope.obj).then(function (response) {
    ...
    $scope.buscar = function (form) {
        if ($scope.obj.id !== "") {
            rolService.buscar($scope.obj).then(function (response) {
